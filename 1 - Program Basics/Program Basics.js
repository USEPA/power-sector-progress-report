...
var credits = ("EPA, " + currentYear + "<br/>Last Updated: 07/24");
var figure1Captions = 'Notes:<br/>• To more clearly see the states included in the "CSAPR (SO₂ and annual NOₓ)" program, use the interactive features of the figure: click on the boxes in the legend to turn off the pink, orange, and green categories (labeled “CSAPR NOₓ Ozone Season”).<br/>• Group 1 is CSAPR. Group 2 is CSAPR Update. Group 2E is Revised CSAPR Update. Group 3 is GNP.';
...
var fig3Years = [2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, reportYear];
var electricityData = [{
    name: 'Coal',
    data: [2058988791, 2039272267, 2061841197, 2027959218, 1819291910, 1918277344, 1808118031, 1584916611, 1660636289, 1656999186, 1433367234, 1320279400, 1285802929, 1227459510, 1031238637, 832509441, 963993107, 906902785, 743193014],
  },
  {
    name: 'Gas',
    data: [597869097, 630053679, 716637541, 707106386, 757686277, 810821820, 846890732, 1052002995, 974258478, 981114138, 1194485668, 1241868583, 1176641889, 1352199362, 1465270243, 1508415933, 1459216151, 1562252167, 1680762424],
  },
  {
    name: 'Oil',
    data: [73211975, 37527181, 42192024, 32029275, 23678414, 24993545, 17892137, 16485997, 10795236, 11162198, 14393085, 10775630, 4565913, 6492430, 3262733, 2180465, 2042937, 3573701, 2697225],
  },
  {
    name: 'Other',
    data: [1716096, 2031195, 2517899, 2877085, 2875301, 3832958, 5334007, 4633171, 6649203, 8080785, 7245485, 7074216, 7249505, 7509531, 5676098, 5806498, 6772544, 5989504, 3776143],
  }
];

var programData = [{
    name: 'Coal EGUs',
    data: [350, 421, 290, 294, 290],
  },
  {
    name: 'Gas EGUs',
    data: [77, 2714, 1529, 1955, 1529],
  },
  {
    name: 'Oil EGUs',
    data: [0, 71, 200, 150, 200],
  },
  {
...
Highcharts.chart('timelineContainer', {
  ...
  //set to false to hide horizontal lines
    ...
    categories:['', 2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009, 2008, 2007, 2006, 2005, 2004, 2003, 2002, 2001, 2000, 1999, 1998, 1997, 1996, 1995],
  },
  plotOptions: {
    series: {
      animation: false,
  ...
  stack: 'acidrain',
    ...
    name: 'CSAPR Annual and <br> Ozone Season NOₓ',
    data: [9],
    //8 years (2015-2023)
    stack: 'two',
    color: 'plum',
  ...
  tooltip: {
    ...
    formatter: function() {
      ...
      if (this.series.index == 0) {
        ...
        string += '<br><strong>Ozone Transport Comission<br>NOₓ Budget Program</strong><br>2000-2003';
      } else if (this.series.index == 4) {
        string += '<br><strong>NOₓ State Implementation Plan Call<br>NOₓ Budget Trading Program</strong><br>2003-2009';
      } else if (this.series.index == 5) {
        string += '<br><strong>Clean Air Interstate Rule SO₂ and NOₓ<br>Annual and Ozone Season NOₓ</strong><br>2009-2015';
      } else if (this.series.index == 6) {
        string += '<br><strong>Cross-State Air Pollution Rule SO₂ and NOₓ<br>Annual and Ozone Season NOₓ</strong><br>2015-Present';
      } else if (this.series.index == 7) {
        string += '<br><strong>Cross-State Air Pollution Rule Update<br>Ozone Season NOₓ</strong><br>2017-2019';
      }else if (this.series.index == 9) {
        string += '<br><strong>Revised Cross-State Air Pollution Rule Update<br>Ozone Season NOₓ</strong><br>2021-Present';
      }else if (this.series.index == 10) {
        string += '<br><strong>Good Neighbor Plan<br>Ozone Season NOₓ</strong><br>2022-Present';
      } else(string = "error");
      if (this.series.name == "") {
        return false
      } else {
...
//This data sets the state for each category
    const basemapData = [
        ['us-ma', null], ['us-wa', null], ['us-ca', null], ['us-or', null], ['us-wi', null], ['us-me', null], ['us-mi', null], ['us-nv', null], ['us-nm', null], ['us-co', null], ['us-wy', null], ['us-ks', null], ['us-ne', null], ['us-ok', null], ['us-mo', null], ['us-il', null], ['us-in', null], ['us-vt', null], ['us-ar', null], ['us-tx', null], ['us-ri', null], ['us-al', null], ['us-ms', null], ['us-nc', null], ['us-va', null], ['us-ia', null], ['us-md', null], ['us-de', null], ['us-pa', null], ['us-nj', null], ['us-ny', null], ['us-id', null], ['us-sd', null], ['us-ct', null], ['us-nh', null], ['us-ky', null], ['us-oh', null], ['us-tn', null], ['us-wv', null], ['us-dc', null], ['us-la', null], ['us-fl', null], ['us-ga', null], ['us-sc', null], ['us-mn', null], ['us-mt', null], ['us-nd', null], ['us-az', null], ['us-ut', null]
    ];
        const CSAPRannual =[
        ...
        ['us-tx', 0],['us-ok', 0],['us-ks', 0],['us-mo', 0],['us-ak', 0],['us-ia', 0],['us-wi', 0],['us-ms', 0],['us-ar', 0],['us-al', 0],['us-tn', 0],
            ...
            const ozoneGroup2E =[
        ['us-ky', 0],['us-la', 0],['us-wv', 0],
    ];
            const ozoneGroup3 =[
        ['us-ny', 0],['us-nj', 0],['us-pa', 0],['us-md', 0],['us-va', 0],['us-oh', 0],['us-in', 0],['us-mi', 0],['us-il', 0],
    ];
...
Highcharts.mapChart('mapContainer', {
        ...
        title: {
            text: "Map of Program Implementation for " + reportYear
        },
...
if (this.point.name == "Minnesota" || this.point.name == "Nebraska" || this.point.name == "South Carolina" || this.point.name == "North Carolina"|| this.point.name == "Kansas" || this.point.name == "Iowa" || this.point.name == "Missouri" || this.point.name == "South Illinois"|| this.point.name == "Wisconsin"|| this.point.name == "Michigan"|| this.point.name == "Indiana"|| this.point.name == "Ohio"|| this.point.name == "Kentucky"|| this.point.name == "Tennessee"|| this.point.name == "Alabama"|| this.point.name == "Virginia"|| this.point.name == "West Virginia"|| this.point.name == "Maryland"|| this.point.name == "Pennsylvania"|| this.point.name == "New Jersey"|| this.point.name == "New York"|| this.point.name == "Georgia"|| this.point.name == "Illinois"){
                ...
                if(this.point.name=="Kentucky"|| this.point.name=="Louisiana"|| this.point.name=="West Virginia"){
                group2ETooltip='<br/><span style="color:' + group2EColor + '">\u25CF</span> CSAPR NOₓ Ozone Season Group 2E'
                }else{group2ETooltip = ""}

                if(this.point.name=="New York"|| this.point.name=="New Jersey"|| this.point.name=="Pennsylvania"|| this.point.name=="Maryland"|| this.point.name=="Virginia"|| this.point.name=="Indiana"|| this.point.name=="Michigan"|| this.point.name=="Ohio"|| this.point.name=="Illinois"){
                group3Tooltip='<br/><span style="color:' + group3Color + '">\u25CF</span> CSAPR NOₓ Ozone Season Group 3'
                }else{group3Tooltip = ""}                

								return this.point.name + "<br><b>" + csaprTooltip + group1Tooltip + group2Tooltip + group2ETooltip + group3Tooltip;
                },
                },
        series: [{
            name: 'basemap',
            ...
            name: 'CSAPR NOₓ Ozone Season Group 2E',
            data: ozoneGroup2E,
            dataLabels:false,
            color:'#ED561B',
        },{
...
enabled: true
  ...
  exporting: {
    menuItemDefinitions: {
      ...
      xls: {
        onclick: function() {
          window.open('https://www.epa.gov/system/files/documents/2024-07/program-basics-data.xlsx');
        },
        text: 'Download data'
      }
    },
